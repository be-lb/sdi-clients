...
const data = [
    ...
    ['finance-1', '• Contracter un prêt bancaire reste intéressant, plus d’informations sur https://homegrade.brussels/particuliers/pret-vert-bruxellois.', '• Het afsluiting van een lening blijft interessant, meer info via https://homegrade.brussels/particuliers/pret-vert-bruxellois/?lang=nl.'],
