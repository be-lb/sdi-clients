...
// const renderTemporalReference = (a: TemporalReference[]) => {
//     return a.map((t) => {
...
//             ),
//             goButton(() => {
//                 const lid = i.uniqueResourceIdentifier;
//                 const gt = i.geometryType;
//                 layerEvents.view(lid, gt);
//             }),
//             okButton(() => {
//                 appEvents.addMapLayer(i);
//                 appEvents.setCurrentLayer(i.uniqueResourceIdentifier);
